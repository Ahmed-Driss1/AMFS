    ...
    return (
        <>
            <section className="min-h-screen bg-light">
                ...
                <div className="p-5 grid gap-4 lg:gap-y-12 grid-cols-1 lg:grid-cols-3 pt-14 px-4 lg:px-28 ">
                    ...
                    <img src={aboutimage1} alt="group of surfers" className="w-full h-auto lg:col-span-1 lg:order-2 order-2 rounded-lg lg:hover:scale-110 transition-transform duration-500" />

                    {/* Second Row: Image 1/3, Text 2/3 */}
                    <img src={aboutimage2} alt="high performer surfing" className="w-full h-auto lg:col-span-1 lg:order-3 order-4 rounded-lg lg:hover:scale-110 transition-transform duration-500" />
